...
export const useCarts = (dispatch: any, pageNumber: number,subdomain: string = 'maindomain') => {
    ...
    useEffect(() => {
        ...
        const getCartData = async () => {
            ...
            try {
                let { data } = await axios.get(`${SERVER_URL}/carts?page=${pageNumber}&subdomain=${subdomain}`, {
                    headers: {
