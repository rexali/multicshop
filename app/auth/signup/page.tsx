                    ...
                    >
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                ...
                                <Grid item xs={6} sm={6}>
                                    <TextField size='small' defaultValue={'.siniotech.com.ng'} disabled />
                                </Grid>

                                {isAvailable?<Box sx={{color:'green'}}>It is available</Box>:<Box sx={{color:'red'}}>It is not available</Box>}
                            </Grid>
                            <Grid item xs={12}>
                                <TextField
                                    required
